...
/**
 * Custom BottomSheetBehaviour that provides 'two stage' behaviour.
 * This behaviour allows to 'half-open' bottom sheet.
 */
public class TwoStageBottomSheetBehavior<V : View> : CoordinatorLayout.Behavior<V> {
    ...
    companion object {
        ...
        @JvmStatic
        fun from(view: View): TwoStageBottomSheetBehavior<*> {
            ...
            return lp.behavior as? TwoStageBottomSheetBehavior
    ...
    var state
        ...
        set(@State value) {
            ...
            viewRef?.get()?.apply {
                ...
                if (parent != null && parent.isLayoutRequested && ViewCompat.isAttachedToWindow(this)) {
                    post {
    ...
    var halfExpandedHeight: Int? = null
//        set(value) {
//            field = value
//            halfExpandedOffset = calculateHalfExpandedOffset()
//            if (state == STATE_HALF_EXPANDED) {
//                viewRef?.get()?.apply {
//                    Log.d("CustomBottomBehaviour", "${parent?.isLayoutRequested}")
//                    if (parent != null && parent.isLayoutRequested && ViewCompat.isAttachedToWindow(this)) {
//                        post {
//                            startSettlingAnimation(this, state)
//                        }
//                    } else {
//                        startSettlingAnimation(this, state)
//                    }
...
//    private fun applyHalfExpandOffset() {
//        viewRef?.get()?.apply {
//            Log.d("CustomBottomBehaviour", "${parent?.isLayoutRequested}")
//            if (parent != null && parent.isLayoutRequested && ViewCompat.isAttachedToWindow(this)) {
//                post {
...
//    }
    ...
    private fun calculateHalfExpandedOffset(): Int {
        if (halfExpandedHeight == null) return 0
        viewRef?.get()?.height?.let { height -> return max(height - halfExpandedHeight!!, 0) }
        return 0
    }
    ...
    private val dragCallback: ViewDragHelper.Callback = object : ViewDragHelper.Callback() {
        ...
        override fun clampViewPositionVertical(child: View, top: Int, dy: Int): Int {
            val maxOffset = max(if (isHideable) parentHeight else collapsedOffset, 0)
...
private fun Parcel.writeBooleanUsingCompat(value: Boolean) = ParcelCompat.writeBoolean(this, value)

/** Read a boolean from a Parcel. */
private fun Parcel.readBooleanUsingCompat() = ParcelCompat.readBoolean(this)