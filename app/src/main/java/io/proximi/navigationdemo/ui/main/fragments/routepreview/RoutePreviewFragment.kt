...
class RoutePreviewFragment : Fragment() {
    ...
    private fun routeUpdated(route: Route?) {
        ...
        if (route != null) {
            ...
            stepsTextView.text = UnitHelper.getDistanceInPreferenceUnit(distanceInMeters, requireContext())
    ...
    private fun updateActivityOffset() {
        if (activity != null && view != null) {
            activity!!.setBottomOffset(view!!.height - min(summaryView.top, summaryView.top), true)
        }
    }
